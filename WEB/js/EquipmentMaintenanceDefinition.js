...
function EquipmentMaintananceDefinitionDelete(sender) {
    ...
    document.getElementById('dialogEquipmentMaintananceDefinitionDeleteName').innerHTML = EquipmentMaintenanceDefinition.Description;
...
function dialogEquipmentMaintananceDefinitionDeleteConfirmed() {
    var webMethod = "/Async/EquipmentMaintenanceActions.asmx/Delete";
    var data = { equipmentMaintenanceDefinitionId: SelectedEquipmentDefinitionSelectedId, companyId: Company.Id, userId: user.Id };
    $.ajax({
        type: "POST",
        url: webMethod,
        contentType: "application/json; charset=utf-8",
