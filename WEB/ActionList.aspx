                                            ...
                                            <table class="table table-bordered table-striped" style="margin: 0">
                                                <thead class="thin-border-bottom">
                                                    <tr id="ListDataHeader">
														...
														<th onclick="Sort(this,'ListDataTable','text',false);" id="th3" class="sort search" style="width:250px;"><%=this.Dictionary["Item_IncidentAction_Header_Origin"] %></th>
                                                        <th onclick="Sort(this,'ListDataTable','text',false);" id="th4" class="sort search" style="width:100px;"><%=this.Dictionary["Item_IncidentAction_Header_Type"] %></th>
