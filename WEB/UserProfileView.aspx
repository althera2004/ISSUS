                                                    ...
                                                    <form class="form-horizontal" role="form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <span class="ErrorMessage" id="TxtPassActualErrorRequired"><%=this.Dictionary["Common_Required"] %></span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <span class="ErrorMessage" id="TxtPassNew1ErrorRequired"><%=this.Dictionary["Common_Required"] %></span>
                                                                <span class="ErrorMessage" id="TxtPassNew1ErrorMatch"><%=this.Dictionary["Item_User_ErrorMessage_PaswordsNoMatch"] %></span>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <span class="ErrorMessage" id="TxtPassNew2ErrorRequired"><%=this.Dictionary["Common_Required"] %></span>
                                                                <span class="ErrorMessage" id="TxtPassNew2ErrorMatch"><%=this.Dictionary["Item_User_ErrorMessage_PaswordsNoMatch"] %></span>
                                                            </div>
                                                        </div>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ScriptBodyContentHolder" Runat="Server">
        ...
        <script type="text/javascript">
            ...
            jQuery(function ($) {
                ...
                SetToolTip("DivCmbIdioma", Dictionary.Item_Employee_Help_Language);
                SetToolTip("chkShowHelp",Dictionary.Item_Employee_Help_OnlineHelp);
                SetToolTip("ButtonBlue", Dictionary.Item_Employee_Help_IconCommon_Color_Blue);
                SetToolTip("ButtonGreen", Dictionary.Item_Employee_Help_IconCommon_Color_Green);
                SetToolTip("ButtonRed", Dictionary.Item_Employee_Help_IconCommon_Color_Red);
                SetToolTip("ButtonYellow", Dictionary.Item_Employee_Help_IconCommon_Color_Yellow);
                SetToolTip("Contentholder1_CmbShorcuts", Dictionary.Item_Employee_Help_Shortcuts);
                SetToolTip("TxtPassActual", Dictionary.Item_Employee_Help_PasswordActual);
                SetToolTip("TxtPassNew1", Dictionary.Item_Employee_Help_NewPassword);
                SetToolTip("TxtPassNew2", Dictionary.Item_Employee_Help_ConfirmarNuevoPassword);
