                                                        ...
                                                        <table class="table table-bordered table-striped" style="margin-top: 4px; margin-bottom: 0;">
                                                            <thead class="thin-border-bottom" id="RegistrosTHead">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th id="th5" onclick="Sort(this,'ObjetivoRegistrosTable','text',false);" class="sort" style="width: 150px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Responsible"]%></th>
