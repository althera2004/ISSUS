                                                            ...
                                                            <div class="col-sm-2">
                                                                <div class="row">
                                                                    <div class="col-xs-12 col-sm-12 tooltip-info" id="DateStartDiv">
                                                                        ...
                                                                        <span class="ErrorMessage" id="DateStartDateOutOfDate" style="display:none;"><%=this.Dictionary["Item_BusinessRisk_ErrorMesagge_OutOfDate"] %></span>
                                                                        <span class="ErrorMessage" id="DateStartDateUpToLimit" style="display:none;"><%=this.Dictionary["Item_BusinessRisk_ErrorMessage_DateUpToLimit"] %></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div>
                                                        <form class="form-horizontal" role="form">
                                                            <div class="col-sm-12" style="border:1px solid #eee;background-color:#fcfcfc;">
                                                                ...
                                                                <!--
                                                                <div style="border:1px solid #777;background-color:#f0f0ff;padding:12px;margin-bottom:12px;" id="_DivClosingRisk">
                                                                    <h4><strong><%=this.Dictionary["Item_BusinessRisk_Title_FinalResult"] %></strong></h4>
                                                                    <div class="form-group">
                                                                        <label class="col-sm-2"><%=this.Dictionary["Item_BusinessRisk_LabelField_ApplyAction"] %></label>
                                                                        <div class="col-sm-1"><input type="radio" value="0" id="FinalApplyAction1" name="FinalApplyAction" onclick="FinalApplyActionFalse();" /><%=this.Dictionary["Common_No"] %></div>
                                                                        <div class="col-sm-1"><input type="radio" value="1" id="FinalApplyAction2" name="FinalApplyAction" onclick="FinalApplyActionTrue();" /><%=this.Dictionary["Common_Yes"] %></div>
                                                                        <div class="col-sm-2"><input type="checkbox" value="0" id="FinalAssumed" name="FinalAssumed" onclick="FinalAssumedChanged();" /><%=this.Dictionary["Item_BusinessRisk_LabelField_Assumed"] %></div>
