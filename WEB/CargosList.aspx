                                            ...
                                            <table class="table table-bordered table-striped" style="margin: 0">
                                                <thead class="thin-border-bottom">
                                                    <tr id="ListDataHeader">
                                                        ...
                                                        <th style="cursor:pointer;width:200px;" onclick="Sort(this,'ListDataTable','text',false);" id="th1" class="sort search"><%=this.Dictionary["Item_JobPosition_ListHeader_Responsible"] %></th>
                                                        <th style="cursor:pointer;width:200px;" onclick="Sort(this,'ListDataTable','text',false);" id="th2" class="sort search hidden-480"><%=this.Dictionary["Item_JobPosition_ListHeader_Department"] %></th>
