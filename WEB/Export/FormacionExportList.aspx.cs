...
public partial class Export_FormacionExportList : Page
{
    ...
    public static ActionResult PDF(int companyId, string yearFrom, string yearTo, int mode)
    {
        ...
        float[] widths = new float[] { 15f, 20f, 5f };
        ...
        foreach (Learning learning in learningFilter.Filter())
        {
            ...
            iTSpdf.PdfPCell cellDate = new iTSpdf.PdfPCell(new iTS.Phrase(learning.Description, times));
            cellDate.Border = border;
            cellDate.Padding = 6f;
            cellDate.PaddingTop = 4f;
            table.AddCell(cellDate);

            iTSpdf.PdfPCell typeCell = new iTSpdf.PdfPCell(new iTS.Phrase(assist, times));
            ...
            iTSpdf.PdfPCell operationCell = new iTSpdf.PdfPCell(new iTS.Phrase(fecha, times));
            operationCell.Border = border;
            operationCell.Padding = 6f;
            operationCell.PaddingTop = 4f;
            operationCell.HorizontalAlignment = Rectangle.ALIGN_CENTER;
