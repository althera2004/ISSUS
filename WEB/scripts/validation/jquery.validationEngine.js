     ...
     var methods = {
         ...
         */
         init: function (options) {
             var form = this;
             if (true || !form.data('jqv') || form.data('jqv') == null) {
         ...
         */
         attach: function (userOptions) {
             ...
             $.validationEngine.defaults.targetForm = this;
             ...
             if (userOptions.btn != null) { $('#' + userOptions.btn).click(methods._onSubmitEvent); }
             if (userOptions.onSuccessAction != null) { $.validationEngine.defaults.onSuccessAction = userOptions.onSuccessAction; }
             return this;
         },
         /**
         ...
         */
         _onSubmitEvent: function () {
             ...
             if (!$(this).is("form")) {
                 form = $.validationEngine.defaults.targetForm;
             }
             ...
             if (r === true && $.validationEngine.defaults.onSuccessAction != null) {
                 $.validationEngine.defaults.onSuccessAction.call();
             }
