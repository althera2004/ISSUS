...
<FONT FACE="calibri" SIZE="4" COLOR="black">
  <p>Hola #USERNAME#!</p>
  <p>La empresa #EMPRESA# ha regenerado tu contraseña de acceso.</p>
  <p>
    Puedes acceder a la aplicación desde <a href="http://issus.scrambotika.com/">este enlace</a> con los siguientes datos:</p>
<li>
  ...
  <p>Gracias per confiar en ISSUS.</p>
  <p>
