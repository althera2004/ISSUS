// --------------------------------
// <copyright file="BusinessRisksList.aspx.cs" company="OpenFramework">
...
public partial class BusinessRisksList : Page
{
    ...
    public void FillCombos()
    {
        ...
        var resp = new StringBuilder(@"<option value=""0"">").Append(this.Dictionary["Common_All_Male_Plural"]).Append("</option>");
