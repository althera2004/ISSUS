<%@ Page Title="" Language="C#" MasterPageFile="~/Giso.master" AutoEventWireup="true" CodeFile="UnidadView.aspx.cs" Inherits="UnidadView" %>
                                                ...
                                                <div id="home" class="tab-pane active">                                                
                                                    <form class="form-horizontal" role="form">
                                                        <div class="form-group">
                                                            <label id="TxtNameLabel" class="col-sm-1 control-label no-padding-right"><%=this.Dictionary["Item_Unidades"]%><span style="color:#f00">*</span></label>
                                                            <%=this.TxtName %>
                                                        </div>

                                                        <% if (this.UnidadId != -1 && this.UnidadId == -1)
                                                           { %>
    ...
    <script type="text/javascript">
        function Save() {
            ...
            else
            {
                ...
                {
                    var description = unidades[x].Description.toLowerCase();
                    if(description == document.getElementById('TxtName').value.toLowerCase() && unidades[x].Id != unidadId)
                    {
                        duplicated = true;
                        break;
                    }
        ...
        jQuery(function ($) {
            ...
            $.widget("ui.dialog", $.extend({}, $.ui.dialog.prototype, {
                ...
                <%if(this.ShowHelp) { %>
                SetToolTip('TxtName',"<%=this.Dictionary["Item_Unidad_Help_Description"] %>");
