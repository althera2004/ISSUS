                                                    ...
                                                    <div>
                                                        <form class="form-horizontal" role="form">
                                                            ...
                                                            <div class="form-group" id="ROriginDiv" style="display: _none;">
                                                                ...
                                                                <div class="col-sm-1"><input type="radio" value="0" id="ROrigin1" name="ROrigin" /><%=this.Dictionary["Item_IncidentAction_Origin1"] %></div>
                                                            ...
                                                            <div class="form-group" id="RTypeDiv" style="display: _none;">
                                                                ...
                                                                <div class="col-sm-1"><input type="radio" value="0" id="RType1" name="RType" /><%=this.Dictionary["Item_IncidentAction_Type1"] %></div>
                                                                <div class="col-sm-1"><input type="radio" value="1" id="RType2" name="RType" /><%=this.Dictionary["Item_IncidentAction_Type2"] %></div>
                                                                <div class="col-sm-1"><input type="radio" value="2" id="RType3" name="RType" /><%=this.Dictionary["Item_IncidentAction_Type3"] %></div>
