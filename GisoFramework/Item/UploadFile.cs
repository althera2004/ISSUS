    ...
    public class UploadFile
    {
        ...
        public static string GetQuota(Company company)
        {
            ...
            return string.Format(
                CultureInfo.InvariantCulture,
                @"[
                    {{""label"": ""{0}"", ""total"": {1}, ""value"": {2}}},
                    {{""label"": ""{3}"", ""total"": {4}, ""value"": {5}}},
                    {{""label"": ""{6}"", ""total"": {7}, ""value"": {8}}},
                    {{""label"": ""{9}"", ""total"": {10}, ""value"": {11}}},
                    {{""label"": ""{12}"", ""total"": {13}, ""value"": {14}}},
                    {{""label"": ""{15}"", ""total"": {16}, ""value"": {17}}},
                    {{""label"": ""{18}"", ""total"": {19}, ""value"": {20}}},
                    {{""label"": ""{21}"", ""total"": {22}, ""value"": {23}}},
                    {{""label"": ""{24}"", ""total"": {25}, ""value"": {26}}},
                    {{""label"": ""{27}"", ""total"": {28}, ""value"": {29}}},
                    {{""label"": ""{30}"", ""total"": {31}, ""value"": {32}}},
                    {{""label"": ""{33}"", ""total"": {34}, ""value"": {35}}},
                    {{""label"": ""{36}"", ""total"": {37}, ""value"": {38}}},
                    {{""label"": ""{39}"", ""total"": {40}, ""value"": {41}}},
                    {{""label"": ""{42}"", ""total"": {43}, ""value"": {44}}}
                ];",
