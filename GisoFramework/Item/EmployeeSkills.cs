...
namespace GisoFramework.Item
{
    ...
    public class EmployeeSkills : BaseItem
    {
        ...
        public EmployeeSkills(long employeeId, int companyId)
        {
             ...
             * @EmployeeId int,
             * @CompanyId int */
            using (SqlCommand cmd = new SqlCommand("EmployeeSkills_GetByEmployee"))
            {
        ...
        /// <summary>
        /// Gets an empty employees' skills
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the employee of skills
        /// </summary>
        public Employee Employee { get; set; }

        /// <summary>
        /// Gets or sets the text for academic skills
        /// </summary>
        public string Academic { get; set; }

        /// <summary>
        /// Gets or sets the text for specific skills
        /// </summary>
        public string Specific { get; set; }

        /// <summary>
        /// Gets or sets the for for the work experience of employee
        /// </summary>
        public string WorkExperience { get; set; }

        /// <summary>
        /// Gets or sets the text for employee's abilities
        /// </summary>
        public string Ability { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether academic skills are valid
        /// </summary>
        public bool? AcademicValid { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether specific skills are valid
        /// </summary>
        public bool? SpecificValid { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether work experience of employee are valid
        /// </summary>
        public bool? WorkExperienceValid { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether employee's abilities are valid
        /// </summary>
        public bool? AbilityValid { get; set; }

        /// <summary>
        /// Gets link to Employee Skill page
        /// </summary>
        ...
        public override string JsonKeyValue
        {
            get
            {
                return string.Format(CultureInfo.GetCultureInfo("en-us"), @"{{""Id"":{0}, ""Name"":""{1}""}}", this.Id, Tools.JsonCompliant(this.Description));
            }
        }
        ...
        /// <summary>
        /// Insert an employee's skill into data base
        /// </summary>
        ...
        public ActionResult Insert(int userId)
        {
             ...
             * @HabilityValid bit,
             * @UserId int */
            using (SqlCommand cmd = new SqlCommand("EmployeeSkills_Insert"))
            {
                cmd.Connection = new SqlConnection(ConfigurationManager.ConnectionStrings["cns"].ConnectionString);
                try
                {
        ...
        /// <summary>
        /// Update employee skills in data base
        /// </summary>
        ...
        public ActionResult Update(int userId)
        {
             ...
             * @HabilityValid bit,
             * @UserId int */
            using (SqlCommand cmd = new SqlCommand("EmployeeSkills_Update"))
            {
                cmd.Connection = new SqlConnection(ConfigurationManager.ConnectionStrings["cns"].ConnectionString);
                try
                {
