        ...
        public ActionResult Update(int userId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("JobPosition_Update"))
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.Add(DataParameter.Input("@Description", Tools.LimitedText(this.Description, 50)));
                    cmd.Parameters.Add(DataParameter.Input("@Responsabilidades", this.responsibilities));
                    cmd.Parameters.Add(DataParameter.Input("@Notas", this.notes));
                    cmd.Parameters.Add(DataParameter.Input("@FormacionAcademicaDeseada", this.academicSkills));
                    cmd.Parameters.Add(DataParameter.Input("@FormacionEspecificaDesdeada", this.specificSkills));
                    cmd.Parameters.Add(DataParameter.Input("@ExperienciaLaboralDeseada", this.workExperience));
                    cmd.Parameters.Add(DataParameter.Input("@HabilidadesDeseadas", this.abilities));
        ...
        public ActionResult Insert(int userId)
        {
            ...
            using (SqlCommand cmd = new SqlCommand("JobPosition_Insert"))
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.Add(DataParameter.Input("@Notas", this.notes));
                    cmd.Parameters.Add(DataParameter.Input("@FormacionAcademicaDeseada", this.academicSkills));
                    cmd.Parameters.Add(DataParameter.Input("@FormacionEspecificaDeseada", this.specificSkills));
                    cmd.Parameters.Add(DataParameter.Input("@ExperienciaLaboralDeseada", this.workExperience));
                    cmd.Parameters.Add(DataParameter.Input("@HabilidadesDeseadas", this.abilities));
