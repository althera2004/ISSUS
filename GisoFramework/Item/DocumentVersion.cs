...
namespace GisoFramework.Item
{
    ...
    /// <summary>
    /// Enumeration of document status
    /// </summary>
    ...
    /// <summary>
    /// Implementation of DocumentVersion class.
    /// </summary>
    public class DocumentVersion
    {
        ...
        #region Properties
        /// <summary>
        /// Gets or sets the state of doucment in this version
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the number of version
        /// </summary>
        public int Version { get; set; }

        /// <summary>
        /// Gets or sets the user that performs the last modification of version
        /// </summary>
        public ApplicationUser User { get; set; }

        /// <summary>
        /// Gets or sets the compnay of version
        /// </summary>
        public Company Company { get; set; }

        /// <summary>
        /// Gets or sets the date of version
        /// </summary>
        public DateTime Date { get; set; }

        /// <summary>
        /// Gets or sets the reason of version
        /// </summary>
        public string Reason { get; set; }

        /// <summary>
        /// Gets or sets the name of creator
        /// </summary>
        ...
        /// <summary>
        /// Obtains the version status represented by an integer
        /// </summary>
