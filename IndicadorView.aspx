...
<asp:Content ID="Content4" ContentPlaceHolderID="Contentholder1" Runat="Server">
                                                    ...
                                                    <div class="row">
                                                        <form class="form-horizontal" role="form">   
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-10">                                                                                                                            
                                                                    <input type="text" id="TxtDescription" placeholder="Nom" class="col-xs-12 col-sm-12 tooltip-info" value="" maxlength="100" onblur="this.value=$.trim(this.value);" />
                                                            ...
                                                            <div class="form-group" style="display:none;">
                                                                <label id="CmbTypeLabel" class="col-sm-1 control-label no-padding-right"><%=this.Dictionary["Item_Indicador_Label_Type"] %><span style="color:#f00">*</span></label>
                                                                <div class="col-sm-3" id="DivCmbType" title="" data-rel="tooltip">
                                                                    <select class="form-control col-xs-12 col-sm-12" id="CmbType" data-placeholder="" onchange="">
                                                                        <option value="0"><%=this.Dictionary["Common_All_Male_Plural"] %></option>
                                                                        <option value="1"><%=this.Dictionary["Item_Indicador_Label_TypeObjetivo"] %></option>
                                                                        <option value="2"><%=this.Dictionary["Item_Indicador_Label_TypeProceso"] %></option>
                                                                    </select>
                                                                </div>	
                                                            </div>
                                                            <div class="form-group" style="display:none;">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-4" id="DivCmbAlarmaComparer" style="height:35px !important;" title="" data-rel="tooltip"><!-- data-placement="top"> -->
                                                                    ...
                                                                    &nbsp;                                                                                                                     
                                                                    <input style="display:inline;width:33%;height:30px;"  type="text" id="TxtAlarma" placeholder="Alarma" class="tooltip-info integerFormated" value="0" maxlength="5" onblur="this.value=$.trim(this.value);" />                                                                                       
                                                                </div>
                                                            </div>
                                                            <div class="form-group">	
                                                    ...
                                                    <div class="table-responsive" id="scrollTableDiv">
                                                        <table class="table table-bordered table-striped" style="margin-top: 4px; margin-bottom: 0;">
                                                            <thead class="thin-border-bottom" id="RegistrosTHead">
                                                                ...
                                                                <tr>
                                                                    <th id="th0" onclick="Sort(this,'IndicadorRegistrosTable','money',false);" class="sort" style="width: 90px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Value"]%></th>
                                                                    <th id="th1" onclick="Sort(this,'IndicadorRegistrosTable','date',false);" class="sort" style="width: 90px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Date"]%></th>
                                                                    <th id="th2"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Comments"]%></th>
                                                                    <th id="th3" onclick="Sort(this,'IndicadorRegistrosTable','money',false);" class="sort" style="width: 90px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Meta"]%></th>
                                                                    <th id="th4" onclick="Sort(this,'IndicadorRegistrosTable','money',false);" class="sort" style="width: 90px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Alarm"]%></th>
                                                                    <th id="th5" onclick="Sort(this,'IndicadorRegistrosTable','text',false);" class="sort" style="width: 150px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Responsible"]%></th>
                            ...
                            <div id="dialogNewRecord" class="hide" style="width:500px;">
                                <form class="form-horizontal" role="form" id="FormDialogNewMaintaiment">
                                    ...
                                    <div class="form-group">
                                        <label id ="TxtRegistroCommentsLabel" class="col-sm-3 control-label no-padding-right" for="TxtRegistroComments"><%=this.Dictionary["Item_IndicatorRecord_FieldLabel_Comments"] %></span></label>
                                        <div class="col-sm-9">
