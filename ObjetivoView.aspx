                                        ...
                                        <div class="tabbable">
                                            ...
                                            <div class="tab-content no-border padding-24" style="height:500px;">
                                                        ...
                                                        <form class="form-horizontal" role="form">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label id="TxtNameLabel" class="col-sm-2"><%=this.Dictionary["Item_Objetivo_FieldLabel_Name"] %><span style="color:#f00">*</span></label>
                                                                    <div class="col-sm-10">                                                                                                                            
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <label id="TxtFechaCierrePrevistaLabel" class="col-sm-1 control-label no-padding-right"><%= this.Dictionary["Item_Objetivo_FieldLabel_ClosePreviewDate"] %><span style="color:#f00">*</span></label>
                                                                    <div class="col-sm-3">
                                                                        <div class="row">
                                                            ...
                                                            <div class="for-group">
                                                                ...
                                                                <div class="col-sm-3" id="DivCmbMetaComparer" style="height:35px !important;display:none;" title="" data-rel="tooltip">
                                                                    ...
                                                                    &nbsp;
                                                                    <input style="display:inline;width:33%;height:30px;" type="text" id="TxtMeta" placeholder="Meta" class="tooltip-info integerFormated" value="0" maxlength="5" onblur="this.value=$.trim(this.value);" />
                                                            ...
                                                            <div style="height:12px;clear:both;">&nbsp;</div>
                                                            <div class="form-group">
                                                                <label class="col-sm-1 control-label no-padding-right" id="TxtMetodologiaLabel"><%= this.Dictionary["Item_Objetivo_FieldLabel_Methodology"] %><span style="color:#f00">*</span></label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <div style="height:12px;clear:both;">&nbsp;</div>                                                            
                                                            <div class="form-group">
                                                                <label class="col-sm-1 control-label no-padding-right" id="TxtRecursosLabel"><%= this.Dictionary["Item_Objetivo_FieldLabel_Resources"] %><span style="color:#f00">*</span></label>
                                                                <div class="col-sm-10">
                                                            ...
                                                            <h4><%=this.Dictionary["Item_Objetivo_TitleClose"] %></h4>
                                                            <div class="form-group">
                                                                <%=this.CmbResponsibleClose.Render %>
                                                                <label id="TxtFechaCierreRealLabel" class="col-sm-2 control-label no-padding-right"><%= this.Dictionary["Item_Objetivo_FieldLabel_CloseRealDate"] %></label>
                                                                <div class="col-sm-4">
                                                                    <div class="row">
                                                    ...
                                                    <div class="table-responsive" id="scrollTableDiv">
                                                        <table class="table table-bordered table-striped" style="margin-top: 4px; margin-bottom: 0;">
                                                            <thead class="thin-border-bottom" id="RegistrosTHead">
                                                                ...
                                                                <tr>
                                                                    <th id="th0" onclick="Sort(this,'ObjetivoRegistrosTable','money',false);" class="sort" style="width: 90px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Value"]%></th>
                                                                    <th id="th1" onclick="Sort(this,'ObjetivoRegistrosTable','date',false);" class="sort" style="width: 90px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Date"]%></th>
                                                                    <th id="th2"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Comments"]%></th>
                                                                    <th id="th3" onclick="Sort(this,'ObjetivoRegistrosTable','money',false);" class="sort" style="width: 90px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Meta"]%></th>
                                                                    <!--<th id="th4" onclick="Sort(this,'ObjetivoRegistrosTable','money',false);" class="sort" style="width: 90px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Alarm"]%></th>-->
                                                                    <th id="th4" onclick="Sort(this,'ObjetivoRegistrosTable','text',false);" class="sort" style="width: 150px;"><%=this.Dictionary["Item_Indicador_TableRecords_Header_Responsible"]%></th>
                                                ...
                                                <div id="graphics" class="tab-pane">
                                                    <div id="barChartDiv" class="col col-sm-9"></div>
                                                    <div id="payloadMeterDiv" class="col col-sm-3"></div>
                                                </div>
                                            </div>                                            
                                        </div>
                                    </div>
                            ...
                            <div id="dialogNewRecord" class="hide" style="width:500px;">
                                <form class="form-horizontal" role="form" id="FormDialogNewMaintaiment">
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="col-xs-12 col-sm-12 integer-formated" id="TxtRegistroValue" placeholder="" value="" maxlength="8" onkeypress="validate(event);" />
...
<asp:Content ID="Content5" ContentPlaceHolderID="ScriptBodyContentHolder" Runat="Server">
        ...
        <script type="text/javascript" src="/js/ObjetivoView.js?<%=this.AntiCache %>"></script>
</asp:Content>
