                                            ...
                                            <table class="table table-bordered table-striped" style="margin: 0">
                                                <thead class="thin-border-bottom">
                                                    <tr id="ListDataHeader">
                                                        <th id="th0" class="search"><%=this.Dictionary["Item_Indicador_Header_Description"] %></th>
                                                        <th id="th1" style="width:300px;"><%=this.Dictionary["Item_Indicador_Header_Process"] %></th>
                                                        <th id="th2" class="sort"  style="width:150px;" onclick="Sort(this,'ListDataTable','date',false);"><%=this.Dictionary["Item_Indicador_Header_ProcessType"] %></th>
                                                        <!-- <th id="th3" class="search" style="width:200px;"><%=this.Dictionary["Item_Indicador_Header_Objetivo"] %></th> -->
                                                        <!-- <th id="th4" class="sort hidden-480" style="width:100px;" onclick="Sort(this,'ListDataTable','date',false);"><%=this.Dictionary["Item_Indicador_Header_ProcessResponsible"] %></th> -->
                                                        <th id="th6" class="sort hidden-480" style="width:150px;" onclick="Sort(this,'ListDataTable','date',false);"><%=this.Dictionary["Item_Indicador_Header_ObjetivoResponsible"] %></th>
